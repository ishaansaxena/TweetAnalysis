...
def main():
    ...
    plt.savefig('plots/tweet_by_lang', format='png')
    ...
    plt.savefig('plots/tweet_by_country', format='png')
    ...
    plt.grid()
    plt.savefig('plots/tweet_by_prg_language_1', format='png')
    ...
    tweets['relevant'] = tweets['text'].apply(lambda tweet: word_in_text('programming', tweet) or word_in_text('tutorial', tweet) or word_in_text('code', tweet))
    ...
    ax.set_xticklabels(prg_langs)
    plt.grid()
    plt.savefig('plots/tweet_by_prg_language_2', format='png')
